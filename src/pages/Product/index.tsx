...
const Product = () => {
  ...
  return (
    <>
      ...
      <Section title="Mais detalhas" background="gray">
        <p>
          <b>Plataforma:</b> PlayStation 5<br /> <b>Desenvolvedor:</b> Avalanche
          Software <br />
          ...
          idiomas, incluindo inglês, espanhol, francês, alemão, <br /> italiano,
          português,entre outros. As opções de áudio e legendas podem ser
          ajustadas nas <br />
          configurações do jogo.
        </p>
      </Section>
      <Gallery name="Jogo teste" defaultCover={spider} />
    </>
  )
}
